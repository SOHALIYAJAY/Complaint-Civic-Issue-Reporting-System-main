...
import {
  ...
  Calendar, Tag, Building, Map, RefreshCw, Activity
} from 'lucide-react'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {complaint.upload_image && (
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                  <ImageIcon className="w-5 h-5 text-blue-500" />Attached Media
                </h3>
                <img src={complaint.upload_image} alt="Complaint attachment" className="w-full h-48 object-cover rounded-lg border border-gray-200" />
              </div>
            )}
